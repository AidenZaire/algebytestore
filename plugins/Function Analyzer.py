...
class FunctionAnalyzer(PluginWidget):
    ...
    def run(self):
        ...
        """
        # If the main app wants to listen for back navigation:
        if not hasattr(self, 'back_requested'):
            from PySide6.QtCore import Signal
            type(self).back_requested = Signal()
